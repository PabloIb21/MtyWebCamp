...
$transaccion->setAmount($cantidad)
            ...
            ->setDescription('Pago MTYWebCamp ')
            ->setInvoiceNumber($ID_registro);

$redireccionar = new RedirectUrls();
$redireccionar->setReturnUrl(URL_SITIO . "/pago_completo.php?&id_pago={$ID_registro}")
            ->setCancelUrl(URL_SITIO . "/pago_incompleto.php?&id_pago={$ID_registro}");
